...
export class UserRoles1717606839286 implements MigrationInterface {
    name = 'UserRoles1717606839286'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`user_roles\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`userId\` int NOT NULL, \`roleId\` int NOT NULL, \`user_id\` int NULL, \`role_id\` int NULL, PRIMARY KEY (\`userId\`, \`roleId\`)) ENGINE=InnoDB`);
